...
if __name__ == "__main__":
    ...
    nnf_x, nnf_y, nnf_D = test.init_nnf()
    cv2.imwrite('xi.jpg',nnf_x)
    cv2.imwrite('yi.jpg',nnf_y)
    cv2.imwrite('di.jpg',nnf_D)
    
    nnf_x, nnf_y, nnf_D = test.improve_nnf() 
    cv2.imwrite('x.jpg',nnf_x)
    cv2.imwrite('y.jpg',nnf_y)
    cv2.imwrite('d.jpg',nnf_D)
